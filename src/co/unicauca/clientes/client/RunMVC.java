...
import co.unicauca.clientes.vista.GUISexoGrafica;
/**
 *
...
public class RunMVC {
    ...
    public RunMVC() {
        ...
        GUIEstadisticaSexo myView3 = new GUIEstadisticaSexo(400, 460);
        GUISexoGrafica myView4 = new GUISexoGrafica(900, 460);
